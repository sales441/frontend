  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-gray-700 text-white">
      <form
        ...
        className="bg-gray-800 p-10 rounded-2xl shadow-xl w-96"
      >
        ...
        <button className="w-full bg-yellow-500 hover:bg-yellow-400 text-gray-900 font-semibold py-3 rounded-lg">
          Entrar
        </button>
      </form>
    </div>
